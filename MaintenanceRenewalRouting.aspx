<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaintenanceRenewalRouting.aspx.cs" Inherits="PrepumaWebApp.MaintenanceRenewalRouting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container">
        Contract Renewal Routing Email Maintenance
    <div>
    ...
    <div>
           ...
           <ExportSettings ExportOnlyData="True" IgnorePaging="true" OpenInNewWindow="true" Excel-Format="ExcelML">
            ...
            <MasterTableView AutoGenerateColumns="False" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idContractRenewalRouting" >
                <EditFormSettings UserControlName="EditRenewalRouting.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="RoutingName" AllowFiltering="true" FilterControlAltText="Filter RoutingName column" HeaderText="Routing Name" SortExpression="RoutingName" UniqueName="RoutingName">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="RoutingEmail" AllowFiltering="true" FilterControlAltText="Filter RoutingEmail column" HeaderText="Routing Email" SortExpression="RoutingEmail" UniqueName="RoutingEmail">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="LoginID" AllowFiltering="true" FilterControlAltText="Filter LoginID column" HeaderText="LoginID" SortExpression="LoginID" UniqueName="LoginID">
                    </telerik:GridBoundColumn>
