<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditRenewalRouting.ascx.cs" Inherits="PrepumaWebApp.EditRenewalRouting" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Contract Renewal Routing Email Maintenance </b>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblRenewalRouteID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idContractRenewalRouting") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblRenewalRouteName" runat="server" CssClass="rdfLabel" Text="Route-to Name" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtRoutingName" runat="server" Text='<%# Bind("RoutingName") %>'  Width="300px" ToolTip="Enter the Route-to Name"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRoutingName" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblRenewalRouteEmail" runat="server" CssClass="rdfLabel" Text="Route-to Email" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtRoutingEmail" runat="server" Text='<%# Bind("RoutingEmail") %>'  Width="300px" ToolTip="Enter the Route-to Email"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRoutingEmail" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
         <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblRenewalRouteLoginID" runat="server" CssClass="rdfLabel" Text="Route-to Login ID" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtLoginID" runat="server" Text='<%# Bind("LoginID") %>'  Width="300px" ToolTip="Enter the Route-to LoginID"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtLoginID" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
