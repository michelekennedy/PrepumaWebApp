<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditRenewalType.ascx.cs" Inherits="PrepumaWebApp.EditRenewalType" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtRenewalType">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtRenewalType"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Contract Renewal Type Maintenance </b>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblRenewalTypeID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idContractRenewalType") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblRenewalType" runat="server" CssClass="rdfLabel" Text="Renewal Type" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtRenewalType" runat="server" Text='<%# Bind("ContractRenewalType") %>'  Width="300px" ToolTip="Enter the Contract Renewal Type"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRenewalType" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
