<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RenewalSheet.aspx.cs" Inherits="PrepumaWebApp.RenewalSheet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
     ...
     <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="300px" ShowEvent="OnClick"
                 ...
                 Text="View Renewal Sheets with Notes only entered by Pricing Group">
     </telerik:RadToolTip>
    ...
    <div id="selectedMenu" style="padding-left:20px"><b>Renewal Sheet</b>
     ...
     <br /> 
        ...
        <table border="0">
            <tr>
                <td colspan="4">
                    <asp:Label ID="lblDateField" CssClass="alert-link" runat="server" Text="Effective Date Range" Visible="true"></asp:Label>
                </td>
            </tr>
